...
// RoundFishDisplay class, as allowed by the GNU General Public License.
//
// License Information:
 ...
 *
 *  A <code>RoundFishDisplay</code> draws a rounded fish (an object of the
 ...
 *  with a <code>RoundFishDisplay</code> their own specialized look.
 *
 ...
 **/
public class RoundFishDisplay extends FishDisplay
{
    private static final double BODY_WIDTH = .75, BODY_LENGTH = .7;
    private static final double TAIL_WIDTH = .6, TAIL_LENGTH = .3;
    private static final double EYE_SIZE = .12;
    
    /** Constructs an object that knows how to display round-ish fish.
     **/
